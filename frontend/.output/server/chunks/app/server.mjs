import { hasInjectionContext, getCurrentInstance, version, ref, watchEffect, watch, inject, defineAsyncComponent, defineComponent, h, computed, unref, provide, shallowReactive, Suspense, nextTick, Transition, useSSRContext, useAttrs, toValue, toRef, onUnmounted, isRef, mergeProps, withAsyncContext, createVNode, resolveDynamicComponent, resolveComponent, withCtx, renderSlot, openBlock, createBlock, createCommentVNode, toDisplayString, createApp, effectScope, reactive, onErrorCaptured, onServerPrefetch, shallowRef, isReadonly, isShallow, isReactive, toRaw, createSlots, renderList } from 'vue';
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, h as createError$1, n as klona, o as parse, q as getRequestHeader, r as defuFn, t as defu, v as sanitizeStatusCode, x as destr, y as isEqual, z as setCookie, A as getCookie, B as deleteCookie, C as createDefu, D as parseQuery, E as createHooks, F as withTrailingSlash, G as withoutTrailingSlash } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-9tj1C_AM.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard-courses-manager",
    path: "/dashboard/courses/manager",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-EfO-qYSH.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard-courses-subscribes",
    path: "/dashboard/courses/subscribes",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-aEWKGH6d.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard",
    path: "/dashboard",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-0tkUUfvs.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard-users-manager-id",
    path: "/dashboard/users/manager/:id()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-ifBg0ZQ2.mjs').then((m) => m.default || m)
  },
  {
    name: "dashboard-users-manager",
    path: "/dashboard/users/manager",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-fObDDIU4.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-CXbxINpu.mjs').then((m) => m.default || m)
  },
  {
    name: "register",
    path: "/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/register-WqDpIkSf.mjs').then((m) => m.default || m)
  }
];
...
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-U3epqYMW.mjs').then((r) => r.default));
...
const layouts = {
  default: () => import('./_nuxt/default-T5lqkBer.mjs').then((m) => m.default || m)
};
...
const __nuxt_component_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-bd832875"]]);
...
const __nuxt_component_0$4 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$5]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-9oeN3td7.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./_nuxt/error-500-4my-kn7-.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import('./_nuxt/island-renderer-CtYpQ1Zp.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { useAppConfig as A, resolveIconName as B, useSeoMeta as C, _export_sfc as _, __nuxt_component_0$3 as a, __nuxt_component_0$1 as b, createError as c, useRoute as d, entry$1 as default, useUserSession as e, appConfig as f, useUI as g, __nuxt_component_1 as h, useInjectButtonGroup as i, fetchDefaults as j, useRequestFetch as k, looseToNumber as l, mergeConfig as m, navigateTo as n, arrow as o, useRouter as p, __nuxt_component_0$4 as q, getNuxtLinkProps as r, useCookie as s, textarea as t, useHead as u, asyncDataDefaults as v, useNuxtApp as w, checkSession as x, input as y, useToast as z };
