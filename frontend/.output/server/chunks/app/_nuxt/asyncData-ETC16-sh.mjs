import { o as arrow$1, m as mergeConfig, f as appConfig, g as useUI, q as __nuxt_component_0$4, h as __nuxt_component_1, r as getNuxtLinkProps, v as asyncDataDefaults, _ as _export_sfc, a as __nuxt_component_0$3, e as useUserSession, n as navigateTo, s as useCookie, w as useNuxtApp, c as createError, d as useRoute, p as useRouter, b as __nuxt_component_0$1$1 } from '../server.mjs';
import { defineComponent, toRef, computed, useSSRContext, cloneVNode, h as h$1, Fragment, inject, provide, ref, onMounted, onUnmounted, watchEffect, nextTick, watch, shallowRef, getCurrentInstance, onServerPrefetch, mergeProps, withCtx, createVNode, unref, resolveComponent, renderSlot, resolveDynamicComponent, createTextVNode, toDisplayString, openBlock, createBlock, createCommentVNode, renderList, Transition } from 'vue';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderStyle, ssrInterpolate, ssrRenderSlot, ssrIncludeBooleanAttr, ssrRenderClass, ssrRenderList, ssrRenderVNode } from 'vue/server-renderer';
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UButton = __nuxt_component_0$1$1;
...
_sfc_main$4.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/arrow-back.vue");
...
function P(e2, r2, { sorted: t2 = true, relativeTo: l2 = null, skipElements: o2 = [] } = {}) {
  var m2;
  let i2 = (m2 = Array.isArray(e2) ? e2.length > 0 ? e2[0].ownerDocument : void 0 : e2 == null ? void 0 : e2.ownerDocument) != null ? m2 : void 0, n2 = Array.isArray(e2) ? t2 ? O$1(e2) : e2 : E(e2);
...
function y(f2, c2, i2 = computed(() => true)) {
  ...
  }, true), u$1("touchend", (e2) => a2(e2, () => e2.target instanceof HTMLElement ? e2.target : null), true), w("blur", (e2) => a2(e2, () => (void 0).document.activeElement instanceof HTMLIFrameElement ? (void 0).document.activeElement : null), true);
}
function r(e2) {
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/avatar-profile.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_ArrowBack = __nuxt_component_0$1;
      const _component_AvatarProfile = _sfc_main$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "grid grid-rows-1 space-y-2" }, _attrs))}><div class="flex justify-between items-center"><div class="flex gap-1"><div style="${ssrRenderStyle(isBackArrow() ? null : { display: "none" })}">`);
      _push(ssrRenderComponent(_component_ArrowBack, null, null, _parent));
      _push(`</div><h1 class="text-2xl font-semibold">Ol\xE1, ${ssrInterpolate(unref(userName))}</h1></div>`);
      _push(ssrRenderComponent(_component_AvatarProfile, null, null, _parent));
      _push(`</div></div>`);
    };
  }
});
...
export { C, H$1 as H, N$1 as N, P, S, T$1 as T, _sfc_main as _, u$2 as a, S$1 as b, c$2 as c, c$1 as d, N as e, T as f, o$2 as g, l, m, o$1 as o, p$2 as p, t, useAsyncData as u, w, y };
//# sourceMappingURL=asyncData-ETC16-sh.mjs.map
